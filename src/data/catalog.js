...
export const cakes = [
 ...
 {id:'baba-de-moca',name:'Baba de Moça com Frutas Vermelhas',description:'Massa de pão de ló, molhada no leite, recheio de baba de moça e geleia de frutas vermelhas. Finalização com frutas vermelhas.',image:'/images/products/bolos/bolo-frutas-vermelhas'},
 {id:'casadinho',name:'Chocolate Casadinho',description:'Massa de chocolate com cacau 50%, molhada no leite, brigadeiro de Ninho e brigadeiro tradicional. Finalização com brigadeiros boleados e morangos frescos.',image:'/images/products/bolos/bolo-chocolate-casadinho'},
