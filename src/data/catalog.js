...
export const sweets = entries.map(([id,name,category,featured,description]) => ({id,name,category,featured,description,composition:description,ingredients:[],highlightIngredients:[],priceGroup:category,available:null,image:`/images/products/brigadeiros/${id}`}));
export const cakes = [
