...
import TastingIntro from './TastingIntro.jsx';
...
export default function SweetsCatalog(){
 ...
 return <>
  ...
  <OrderGuide/>
  <section className="contact"><p className="eyebrow">FALE COM A NANDA</p><h2>Ficou com alguma dúvida?</h2><p>Fale diretamente com a Nanda para confirmar sabores, quantidades, disponibilidade, doces personalizados, entrega e outros detalhes.</p><WA cta_location="contato_catalogo" message="Olá! Vim pelo catálogo de docinhos da Nandices e gostaria de tirar uma dúvida.">Falar com a Nanda</WA><p><a href="https://www.instagram.com/nandices.confeitaria/" target="_blank" rel="noopener noreferrer">@nandices.confeitaria</a></p></section>
 </>;
}
