...
export default function SweetsCatalog(){
 ...
 return <>
  ...
  <section className="personal personalized-catalog section"><div><p className="eyebrow">FEITO PARA O SEU EVENTO</p><h2>Doces Personalizados</h2><p className="section-tagline">Detalhes pensados para combinar com a sua comemoração.</p></div><div><p>Brigadeiros e outros doces com tema, cores, decoração, apresentação e embalagem combinados com você para aniversários, casamentos e eventos especiais.</p><div className="personal-rules"><h3>Doces Personalizados</h3><p>Pedido mínimo de <strong>50 unidades</strong> e antecedência mínima de <strong>45 dias</strong>.</p></div><WA event="whatsapp_personalizado" cta_location="personalizados_catalogo" message="Olá! Vim pelo catálogo da Nandices e gostaria de consultar doces personalizados.">Consultar personalizados pelo WhatsApp</WA></div></section>
