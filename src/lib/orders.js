...
export const sweetsEstimateMessage = value => `Olá! Vim pela calculadora do site da Nandices. Para ${value.guests} convidados em ${value.event}, a calculadora indicou aproximadamente ${value.min} a ${value.max} docinhos. Gostaria de confirmar disponibilidade, quantidade final e os detalhes.`;
