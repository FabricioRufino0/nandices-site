...
A origem textual vem de DELIVERY_ORIGIN; a chave é MAPBOX_ACCESS_TOKEN. VEHICLE_KM_PER_LITER, FUEL_PRICE e DELIVERY_TRIP_MODE continuam privados/configurados no Worker. Fórmula: distância faturável / consumo * preço do combustível, arredondada primeiro em centavos e depois para cima até o próximo real inteiro (R$ 12,23 → R$ 13,00; R$ 12,00 permanece R$ 12,00); round-trip consulta ida e volta independentemente. A fórmula cobre apenas combustível.
